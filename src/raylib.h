...
RLAPI void InitNoWindow(int width, int height, const char *title, void *loader);  // Initialize OpenGL context
RLAPI void InitWindow(int width, int height, const char *title);  // Initialize window and OpenGL context
RLAPI void CloseNoWindow(void);                                   // Unload OpenGL context
